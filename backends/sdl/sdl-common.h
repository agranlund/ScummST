...
public:
	...
	virtual void grab_overlay(NewGuiColor *buf, int pitch);
...
protected:
	...
	virtual int effectiveScreenHeight() { return (_adjustAspectRatio ? 240 : _screen_height) * _scaleFactor; }
